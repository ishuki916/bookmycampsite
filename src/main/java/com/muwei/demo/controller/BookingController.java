...
import com.muwei.demo.model.BookCampsiteListDTO;
...
public class BookingController {
	...
	// 測試用而已
//	@PostMapping("/bookingcomplex")
//	public String selectBooking(Model m,@RequestParam String dateString1,@RequestParam String dateString2,@RequestParam String unitType) throws ParseException {
//		
//		Date date = new Date();
//		date = new SimpleDateFormat("yyyy-MM-dd").parse(dateString1);
//
//		Date date2 = new Date();
//		date2 = new SimpleDateFormat("yyyy-MM-dd").parse(dateString2);
//		mCSer.selectBooking(date,date2,unitType);
//		//mCSer.selectBookinfromCampsite(date,date2,unitType);
//		return "campsite/bookingpage4";
//	}

	// 測試用而已
//	@PostMapping("/bookingcomplex2")
//	public String selectBooking2(Model m,@RequestParam String dateString,
//		@RequestParam String unitType,
//		@RequestParam Integer campsiteId) throws ParseException {
//		//,@RequestParam String dateString1,@RequestParam String dateString2,@RequestParam String unitType
//		Date date = new Date();
//		date = new SimpleDateFormat("yyyy-MM-dd").parse(dateString);
////
////		Date date2 = new Date();
////		date2 = new SimpleDateFormat("yyyy-MM-dd").parse(dateString2);
//		mCSer.getCountOnedaywithId(date,unitType,campsiteId);
//		
//		//date,date2,unitType
//		//mCSer.selectBookinfromCampsite(date,date2,unitType);
//		return "campsite/bookingpage4";
...
//	 List<BookingCampsite> newbclist = mCSer.selectBookingByUserId(userid);
