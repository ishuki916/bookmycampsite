...
<!--<link href="${contextRoot}/muwei/booking4.css" rel="stylesheet">-->
<style>
.mycard1, mycard2 {
	height: 400px;
}
		...
		<div class="container">
			<div class="row">
				...
				<div class="breadcrumb flat" style="display: block">
					<a
						href="#" >Shopping Cart 購物車</a> <a href="#" class="active">Confirm Checkout
						結帳成功</a>
				</div>
				<div class="col-sm-12" id="myOk">
				<div >
				<i class="fas fa-check-circle"></i><span>付款成功</span>
				</div>
				</div>
		<!--			<div class="checkout">
